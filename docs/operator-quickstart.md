# Operator Quickstart — Logging

Shortest path from clone to a verified local dry-run for **ISIC 0220** (`cloud-itonami-isic-0220`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0220.git
cd cloud-itonami-isic-0220
```
...
- Blueprint governor key: `logging-coordination-governor`
- Likely source path: `logging.governor.cljc`
